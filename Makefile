...
ifneq ($(strip $(_dep_missing)),)
  ...
  $(info )
  $(info Install cc65 - version 2.19 or newer, or a current git snapshot)
  $(info (it must provide the 'lynx' target and lynx.lib):)
  $(info .  Debian/Ubuntu : sudo apt install cc65)
  $(info .  macOS (brew)  : brew install cc65)
  $(info .  Arch Linux    : sudo pacman -S cc65)
  $(info .  From source   : https://github.com/cc65/cc65)
  $(info )
